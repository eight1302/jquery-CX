...
(function(){
    ...
    $('#type11').css({"background":"#f5f5f5","color":"#333"});
    //类型一
    ...
    (function(){
        ...
        searchData.on('click','a.assured',function(){
            var _this=$(this),
                ...
                dataNum=parents.attr('data-num'),
                flag =parents.find('.c-item').attr('data-flag');
            ...
            checkboxData='<a href="javascript:;" class="all-classify-item" data-name="'+headerPrefix +'" data-num="'+ dataNum +'" data-flag="'+ flag +'"><span>'+ headerPrefix +'：'+ headerData +'</span><i class="fa fa-close"></i></a>';
            if(dataNum==1){
                //防止点击了多选其实值选择了一个
                if(checkboxheader1.length>1){
                    chuNum++;
                }
                commonData(flag,checkboxheaderName.join(','));
        ...
        navBar.on('click','i.fa-close',function(){
            ...
            if(dataNum==1){
                //判断是渠道
                if(flag == "ditch_code"){
                    $(".ditchId").attr('data-click','true');
                }else if(flag == "supplier_code"){
                    $(".supplierId").attr('data-click','true');
                }
